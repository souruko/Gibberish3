...
--= SliderBoxRow
--= ===============================================================================================
--= Number box with a horizontal slider for values clamped to [0, 1].
--=================================================================================================



Options.Elements.SliderBoxRow = class(Turbine.UI.Control)
---------------------------------------------------------------------------------------------------
function Options.Elements.SliderBoxRow:Constructor( back_color, label_control, label_description, tooltip_description, height )
    ...
    -- textbox (left of slider, 55 px wide)
    self.textbox = Turbine.UI.Lotro.TextBox()
    self.textbox:SetParent( self )
    self.textbox:SetSize( 55, height - 2 * Options.Defaults.window.spacing )
    ...
    -- slider (horizontal scrollbar, range 0–100 maps to opacity 0.0–1.0)
...
---------------------------------------------------------------------------------------------------
function Options.Elements.SliderBoxRow:LanguageChanged()
...
---------------------------------------------------------------------------------------------------
function Options.Elements.SliderBoxRow:SizeChanged()

    local width, height = self:GetSize()
    local sp = Options.Defaults.window.spacing

    -- textbox sits at the standard content offset used by all other rows
    local textbox_left = 130 + 2 * sp
    self.textbox:SetPosition( textbox_left, sp )

    -- frame fills the remaining width
    ...
    -- slider sits inside the frame with 2 px padding on each side
    local pad = 2
...
---------------------------------------------------------------------------------------------------
function Options.Elements.SliderBoxRow:SetText( value )
...
---------------------------------------------------------------------------------------------------
function Options.Elements.SliderBoxRow:GetText()
