...
function GroupTimerTab:Constructor( width, name, tabwindow )
    ...
    function self.timerSelection:SelectionChanged( selectedItem )

        self:GetParent().timerTabs.trigger:FillContent(selectedItem)
...
function GroupTimerTab:SelectionChanged( timerControl )
    ...
    self.timerSelection:ItemSelected( timerControl )
