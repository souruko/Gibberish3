...
function ColorOptions:Constructor( data )
    ...
    --color
    self.color1 = Options.Elements.TextBoxRow( Options.Defaults.window.basecolor, "options", "color1", "TODO", 30 )
    self.color1:SetParent( self )
    self.color1:SetPosition( left, top )
    
    top = top + 30

    self.color2 = Options.Elements.TextBoxRow( Options.Defaults.window.basecolor, "options", "color2", "TODO", 30 )
    self.color2:SetParent( self )
    self.color2:SetPosition( left, top )
    
    top = top + 30

    self.color3 = Options.Elements.TextBoxRow( Options.Defaults.window.basecolor, "options", "color3", "TODO", 30 )
    self.color3:SetParent( self )
    self.color3:SetPosition( left, top )
    
    top = top + 30

    self.color4 = Options.Elements.TextBoxRow( Options.Defaults.window.basecolor, "options", "color4", "TODO", 30 )
    self.color4:SetParent( self )
    self.color4:SetPosition( left, top )
    
    top = top + 30

    self.color5 = Options.Elements.TextBoxRow( Options.Defaults.window.basecolor, "options", "color5", "TODO", 30 )
    ...
    -- opacity
    self.opacityActiv = Options.Elements.TextBoxRow( Options.Defaults.window.basecolor, "options", "opacityActiv", "TODO", 30 )
    self.opacityActiv:SetParent( self )
    self.opacityActiv:SetPosition( left, top )
    
    top = top + 30
    
    self.opacityPassiv = Options.Elements.TextBoxRow( Options.Defaults.window.basecolor, "options", "opacityPassiv", "TODO", 30 )
