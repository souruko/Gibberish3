...
Trigger[ Trigger.Types.TimerEnd ].Defaults.action             = Actions.Add
...
Trigger[ Trigger.Types.TimerStart ].Defaults.action             = Actions.Add
...
Trigger[ Trigger.Types.TimerThreshold ].Defaults.action             = Actions.Add
