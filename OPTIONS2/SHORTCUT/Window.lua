...
function Options.Shortcut.Constructor:Constructor()
    ...
    -- rightclick menu
    self.rightClickMenu = Options2.Elements.RightClickMenu( Options.Defaults.shortcut.menu_width )

    -- right click reset
    self.rc_reset = Options2.Elements.Row( "shortcut", "reset", function ()
            Windows.ResetAll()
        end,
        Options.Defaults.rc_menu.item_height)

    -- right click reload
    self.rc_reload = Options2.Elements.Row( "shortcut", "reload", function ()
            Options.Reload()
        end,
        Options.Defaults.rc_menu.item_height)

    -- right click options
    self.rc_options2 = Options2.Elements.Row( "shortcut", "options2", function ()
            Options2.ToggleWindow()
        end,
        Options.Defaults.rc_menu.item_height)

    -- right click move
    self.rc_move = Options2.Elements.CheckRow( "shortcut", "move", function ()
    ...
    self.rc_target = Options2.Elements.CheckRow( "shortcut", "track_target", function ()
