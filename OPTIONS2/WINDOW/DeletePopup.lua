...
local function _make()
    ...
    card:SetBackColor(Options.Defaults.window.bg)
    ...
    msg:SetForeColor(Options.Defaults.window.text)
    ...
    del_lbl:SetForeColor(Options.Defaults.window.text)
    ...
    can:SetBackColor(Options.Defaults.window.bg_sunken)
    ...
    can_lbl:SetForeColor(Options.Defaults.window.text)
    ...
    can.MouseEnter = function() can:SetBackColor(Options.Defaults.window.select) end
    can.MouseLeave = function() can:SetBackColor(Options.Defaults.window.bg_sunken) end
