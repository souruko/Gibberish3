...
Options2NavFolderTrigger = class(Turbine.UI.Control)
function Options2NavFolderTrigger:Constructor(navWin, trigData, trigType, trigIdx, folderIdx, key, depth)
...
function Options2NavFolderTrigger:SizeChanged()
...
function Options2NavFolderTrigger:SetSelected(v)
    self.selected = v
