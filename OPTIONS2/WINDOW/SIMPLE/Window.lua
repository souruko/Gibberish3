...
function Options2.Window.Simple.Constructor:Constructor()
    ...
    self.timers_name:SetFont(Options2.Fonts.TITLE)
    ...
    self.timers_head_hint:SetFont(Options2.Fonts.SMALL)
    ...
    self.timers_section_label:SetFont(Options2.Fonts.SMALL)
    ...
    self.timers_hint:SetFont(Options2.Fonts.BODY)
    ...
    self.editor_name:SetFont(Options2.Fonts.TITLE)
    ...
    self.editor_kind:SetFont(Options2.Fonts.SMALL)
    ...
    self.editor_hint:SetFont(Options2.Fonts.BODY)
    ...
    self.footer_label:SetFont(Options2.Fonts.SMALL)
    ...
    self.footer_note:SetFont(Options2.Fonts.SMALL)
...
function Options2.Window.Simple.Constructor:_BuildAdvancedCard()
    ...
    self.card_head_label:SetFont(Options2.Fonts.SMALL)
    ...
    self.card_body:SetFont(Options2.Fonts.BODY)
    ...
    for i = 1, MAX_REASON do
        ...
        row.label:SetFont(Options2.Fonts.BODY)
        ...
        row.meta:SetFont(Options2.Fonts.SMALL)
