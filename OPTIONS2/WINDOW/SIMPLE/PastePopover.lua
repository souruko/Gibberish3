...
function Options2SimplePasteItem:Constructor(popover, data, typeIdx)
    ...
    self.token:SetFont(Options2.Fonts.BODY)
    ...
    self.sub:SetFont(Options2.Fonts.SMALL)
...
function Options2.Window.SimplePaste:Constructor()
    ...
    self.head_title:SetFont(Options2.Fonts.SMALL)
    ...
    self.rec_label:SetFont(Options2.Fonts.SMALL)
    ...
    self.rec_btn_label:SetFont(Options2.Fonts.SMALL)
    ...
    self.empty:SetFont(Options2.Fonts.BODY)
